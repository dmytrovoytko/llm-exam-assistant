...
def main():
    print_log("Starting the Exam Assistant application")
    ...
    course = st.selectbox(
        "Select an exam:",
        ["azure-dp-900", "gcp-pde"],
    )
    print_log(f"User selected exam: {course}")
...
if __name__ == "__main__":
    print_log("Exam Assistant application started")
    main()
