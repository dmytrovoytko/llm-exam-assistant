...
def save_conversation(conversation_id, question, answer_data, exam, timestamp=None):
    ...
    try:
        with conn.cursor() as cur:
            cur.execute(
                ...
                (id, question, answer, exam, model_used, response_time, relevance, 
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("""
                ...
                RETURNING timestamp;
            """, 
            ('test', 'test question', 'test answer', 'test exam', 'test model', 0.0, 0.0, 
